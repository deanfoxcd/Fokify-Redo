...
const showRecipe = async function() {
    try {
        ...
        const res = await fetch(`${(0, _configJs.API_URL)}/664c8f193e7aa067e94e8454`);
        const data = await res.json();
        if (!res.ok) throw new Error(`${data.message} (${res.status})`);
        console.log(data);
        let { recipe } = data.data;
        // Getting rid of the underscores in the names of fields
        recipe = {
...
},{"/src/js/config.js":"k5Hzs","../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["hycaY","aenu9"], "aenu9", "parcelRequire2814")
